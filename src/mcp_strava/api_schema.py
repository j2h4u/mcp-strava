...
class FieldSchema:
    ...
    description: str = ""
    summit_null_value: Optional[Any] = None  # What free accounts get for this field
...
SUMMARY_ACTIVITY = EndpointSchema(
    ...
    fields={
        ...
        # 💰 Summit-only
        'suffer_score':         FieldSchema('suffer_score', 'int?', Status.SUMMIT,
                                            summit_null_value=0),
        'perceived_exertion':   FieldSchema('perceived_exertion', 'int?', Status.SUMMIT,
                                            summit_null_value=None),
        ...
        'display_hide_heartrate_option':
                                FieldSchema('display_hide_heartrate_option', 'bool', Status.NOT_APPLICABLE),
    ...
    fields={
        **SUMMARY_ACTIVITY.fields,  # Inherits all SummaryActivity fields
        ...
        'prefer_perceived_exertion':
                                FieldSchema('prefer_perceived_exertion', 'bool?', Status.SUMMIT,
                                            summit_null_value=None),
        'available_zones':      FieldSchema('available_zones', 'list', Status.SUMMIT,
                                            summit_null_value=[]),
...
STREAMS = EndpointSchema(
    ...
    fields={
        ...
        # 🔵 Available, not used yet
        'grade_adjusted_speed':    FieldSchema('grade_adjusted_speed', 'dict', Status.FREE_UNUSED,
                                                'Run only GAP'),
        'grade_adjusted_distance': FieldSchema('grade_adjusted_distance', 'dict', Status.FREE_UNUSED,
                                                'Run only'),
