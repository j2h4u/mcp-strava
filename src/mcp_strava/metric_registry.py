...
COMPUTE_SOURCE_MODULES: tuple[str, ...] = (
    ...
    "mcp_strava.adapters.duckdb.read_model_materializer_utils",
    "mcp_strava.adapters.duckdb.read_model_period_facts",
    ...
    "mcp_strava.metric_registry_fact_column_model",
    "mcp_strava.metric_registry_fact_column_projection",
    "mcp_strava.metric_registry_fact_column_sql",
    "mcp_strava.metric_registry_fact_column_tables",
    "mcp_strava.metric_registry_fact_columns",
    "mcp_strava.metric_registry_metric_factory",
    "mcp_strava.metric_registry_metrics",
    "mcp_strava.metric_registry_metrics_activity",
    "mcp_strava.metric_registry_metrics_analytics",
