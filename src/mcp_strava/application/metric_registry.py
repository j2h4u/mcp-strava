...
_CALCULATION_BY_METRIC_ID = {
    ...
    "trimp": "Per-activity TRIMP = sum(seconds in configured HR zones * Config.Zones.COEFF) / 60 using mirrored heartrate samples.",
    ...
    "hrr_pct": "Median activity heartrate normalized to heart-rate reserve: (median_hr - Config.Athlete.HR_REST) / (observed_hr_max - HR_REST) * 100.",
...
METRIC_REGISTRY: dict[str, MetricDefinition] = {
    ...
    "sport_type": _metric("sport_type", "Sport Type", "category", "activity", "activity", "both", "distribution", "neutral", ["list_workouts", "get_workout_detail"]),
    ...
    "kudos_count": _metric("kudos_count", "Kudos Count", "count", "activity", "activity", "both", "none", "context", ["list_workouts", "get_workout_detail"]),
    "kudos_names": _metric("kudos_names", "Kudos Names", "text_list", "activity", "activity", "both", "none", "context", ["get_workout_detail"]),
    "gear_id": _metric("gear_id", "Gear ID", "id", "activity", "activity", "both", "none", "context", ["get_workout_detail"]),
    "gear_name": _metric("gear_name", "Gear Name", "text", "activity", "activity", "both", "none", "context", ["get_workout_detail"]),
    "gear_distance_km": _metric("gear_distance_km", "Gear Distance", "km", "activity", "activity", "both", "none", "context", ["get_workout_detail"]),
    "gear_primary": _metric("gear_primary", "Primary Gear", "boolean", "activity", "activity", "both", "none", "context", ["get_workout_detail"]),
    ...
    "elapsed_time_min": _metric("elapsed_time_min", "Elapsed Time", "minutes", "activity", "activity", "both", "sum", "higher_is_more", ["get_workout_detail", "compare_periods"]),
    ...
    "start_time": _metric("start_time", "Start Time", "time", "activity", "activity", "both", "none", "neutral", ["get_workout_detail"]),
    ...
    "cardiac_cost_adjusted": _metric("cardiac_cost_adjusted", "Cardiac Cost Adjusted", "ratio", "metrics", "activity", "per_sport", "median", "lower_is_better", ["get_workout_detail", "compare_periods"]),
    ...
    "cardiac_drift_severity": _metric("cardiac_drift_severity", "Cardiac Drift Severity", "category", "metrics", "activity", "per_sport", "distribution", "context", ["get_workout_detail"]),
    ...
    "cardiac_drift_quality": _metric("cardiac_drift_quality", "Cardiac Drift Quality", "category", "metrics", "activity", "per_sport", "distribution", "context", ["get_workout_detail"]),
    ...
    "daily_trimp": _metric("daily_trimp", "Daily TRIMP", "trimp", "report", "period", "global", "sum", "higher_is_more", []),
    ...
    "by_sport_trimp": _metric("by_sport_trimp", "TRIMP By Sport", "trimp", "report", "period", "both", "distribution", "context", []),
    "by_sport_distance_km": _metric("by_sport_distance_km", "Distance By Sport", "km", "report", "period", "both", "distribution", "higher_is_more", []),
    "by_sport_time_min": _metric("by_sport_time_min", "Time By Sport", "minutes", "report", "period", "both", "distribution", "higher_is_more", []),
    "by_sport_elevation_m": _metric("by_sport_elevation_m", "Elevation By Sport", "m", "report", "period", "both", "distribution", "higher_is_more", []),
    "fitness": _metric("fitness", "Fitness", "model_units", "training", "model", "global", "last", "higher_is_more", ["get_fitness_state", "compare_periods"]),
    "fatigue": _metric("fatigue", "Fatigue", "model_units", "training", "model", "global", "last", "higher_is_more", ["get_fitness_state", "compare_periods"]),
    "form": _metric("form", "Form", "model_units", "training", "model", "global", "last", "higher_is_more", ["get_fitness_state", "compare_periods"]),
    "form_zone": _metric("form_zone", "Form Zone", "category", "training", "model", "global", "none", "context", ["get_fitness_state"]),
    "banister_history": _metric("banister_history", "Banister History", "model_units", "training", "period", "global", "trend", "context", []),
    "acwr": _metric("acwr", "ACWR", "ratio", "report", "model", "global", "last", "context", ["get_fitness_state", "compare_periods"]),
    "acwr_zone": _metric("acwr_zone", "ACWR Zone", "category", "report", "model", "global", "none", "context", ["get_fitness_state"]),
    "acwr_history": _metric("acwr_history", "ACWR History", "ratio", "report", "period", "global", "trend", "context", []),
    ...
    "rolling_median_epkm": _metric("rolling_median_epkm", "Rolling Median Elevation Per KM", "m_per_km", "analytics", "period", "per_sport", "median", "context", []),
    "rolling_median_hr_recovery": _metric("rolling_median_hr_recovery", "Rolling Median HR Recovery", "bpm_per_min", "analytics", "period", "per_sport", "median", "higher_is_better", ["get_fitness_state", "compare_periods"]),
    "rolling_median_cardiac_drift_pct": _metric("rolling_median_cardiac_drift_pct", "Rolling Median Cardiac Drift", "percent", "analytics", "period", "per_sport", "median", "lower_is_better", ["get_fitness_state", "compare_periods"]),
    "volume_7d": _metric("volume_7d", "Volume 7d", "count", "analytics", "period", "global", "sum", "higher_is_more", ["get_fitness_state", "compare_periods"]),
    "volume_28d": _metric("volume_28d", "Volume 28d", "count", "analytics", "period", "global", "sum", "higher_is_more", ["get_fitness_state", "compare_periods"]),
    "load_trend_pct": _metric("load_trend_pct", "Load Trend", "percent", "analytics", "period", "global", "trend", "higher_is_more", []),
    "efficiency_trend_pct": _metric("efficiency_trend_pct", "Efficiency Trend", "percent", "analytics", "period", "per_sport", "trend", "lower_is_better", []),
    "run_90d_median_cc_trend_pct": _metric("run_90d_median_cc_trend_pct", "Run 90d Median CC Trend", "percent", "analytics", "period", "per_sport", "trend", "lower_is_better", []),
    "activity_streak_days": _metric("activity_streak_days", "Activity Streak", "count", "analytics", "period", "global", "last", "higher_is_more", []),
    "rest_streak_days": _metric("rest_streak_days", "Rest Streak", "count", "analytics", "period", "global", "last", "higher_is_more", []),
    "last_hike_days_ago": _metric("last_hike_days_ago", "Last Hike Days Ago", "count", "analytics", "period", "global", "last", "lower_is_recent", []),
    "progressive_load_bonus": _metric("progressive_load_bonus", "Progressive Load Bonus", "ratio", "training", "model", "global", "last", "higher_is_more", []),
    "progressive_cc_trends": _metric("progressive_cc_trends", "Progressive CC Trends", "percent", "training", "model", "per_sport", "trend", "lower_is_better", []),
