...
MATERIALIZED_FACT_COLUMN_REGISTRY: dict[str, dict[str, FactColumnDefinition]] = {
    "activity_metric_facts": _fact_table(
        ...
        (
            ...
            ("hr_max_used", "provenance", (), "Running max heartrate to date used as hr_max for zone bound computation."),
            ("hr_rest_used", "provenance", (), "Athlete resting HR from MCP_STRAVA_HR_REST used for zone bound computation."),
        ),
    ),
