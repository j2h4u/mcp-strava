...
def test_materialize_batched_fact_upserts_match_sequential(tmp_path, monkeypatch):
    ...
    """
    from mcp_strava.adapters.duckdb import read_model_fact_write_repository as read_model_fact_write_repo_module
    ...
    def _materialize_and_dump(cap: int) -> dict[str, list]:
        monkeypatch.setattr(read_model_fact_write_repo_module, "_FACT_UPSERT_BATCH_ROWS", cap)
