...
def test_safe03_baseline_migration_sets_user_version_to_2_idempotently_d02(tmp_path: Path) -> None:
...
def test_migration_v1_to_v2_creates_refresh_tables_and_preserves_parity(tmp_path: Path) -> None:
    from mcp_strava.adapters.sqlite.migrations import run_migrations
...
def test_preflight_v2_includes_refresh_tables(tmp_path: Path) -> None:
