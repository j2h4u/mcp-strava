...
┌──────────────────────────────────────────────────────────────────────────┐
│                         Interfaces Layer                                  │
│   HTTP MCP (FastMCP/SSE)          CLI (python -m mcp_strava)             │
...
│  freshness.py  mirror_coverage.py  metric_registry.py                   │
│  `application/`                                                          │
└──────────┬───────────────────────────────────────┬───────────────────────┘
...
│  │  schema.py  schema_sql      │   │  clock.py  types.py              │  │
...
- Contains: metric services, product fact bundles, aggregate services, freshness assembly, metric registry
...
- Depends on: `settings.py`, `types.py`, `constants.py`, `duckdb` package, `httpx`/`requests`
...
- Contains: `metrics.py`, `training.py`, `hr_zones.py`, `cardiac_drift.py`, `sports.py`, `constants.py`, `types.py`, `settings.py`
